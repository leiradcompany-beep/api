...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, "Example Component"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    "class": "text-gray-600"
  }, "This is an example Vue component running on Laravel Mix with Tailwind CSS.")], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return $data.count++;
    }),
    "class": "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
  }, " Count is: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.count), 1 /* TEXT */)])]);
}
